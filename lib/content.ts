...
export const content = {
  ...
  hero: {
    ...
    description: '1-to-1 in videocall live col Capotecnico. Da casa tua, ovunque in Italia. Ti spediamo TUTTO a casa. Apri la scatola e parti.',
    ...
    trustBadges: [
      ...
      { icon: 'package', label: 'Kit completo a casa' },
    ],
    ...
    tiers: [
      ...
      },
      {
        ...
        features: [
          ...
          'Calendario flessibile, costruito su di te',
          'Licenza professionale LV2 verificabile via QR code',
      ...
      },
      {
        ...
        features: [
          ...
          'Calendario flessibile, costruito su di te',
          'Licenza professionale LV3 verificabile via QR code',
          'Supporto post-diploma per 6 mesi',
          'Ti mandiamo i primi clienti per 6 mesi',
          'Priorità sui lavori complessi che giriamo dal nostro laboratorio',
        ],
        ctaPrimary: { label: 'Iscriviti Ora', type: 'checkout' as const },
        ctaSecondary: { label: 'Parla con un Capotecnico', type: 'lead' as const },
        guarantee: 'Garanzia 14 giorni - Prima lezione di prova gratuita',
  ...
  faq: {
    ...
    questions: [
      ...
      {
        question: 'Cosa mi arriva a casa?',
        answer: 'Tutto quello che serve per imparare. Kit professionale di strumenti, setup videocall completo (webcam frontale e webcam con braccio dall\'alto), telefoni su cui esercitarti, materiali didattici digitali, accesso al gruppo WhatsApp dei corsisti. Spedizione tracciata in tutta Italia, da 2 a 5 giorni lavorativi. Apri la scatola, colleghi al PC, sei pronto per la prima lezione live.',
      },
      {
      ...
      },
      {
        ...
        answer: 'No, la webcam te la spediamo noi col kit. È una webcam professionale con braccio articolato flessibile e ring light integrato, plug-and-play su Mac, Windows e Chromebook. Si fissa al banco di lavoro in 30 secondi, posizionata dall\'alto, così il Capotecnico durante le lezioni live vede esattamente quello che fai con le mani. Zero pensieri tecnici: apri la scatola e funziona.',
      },
      {
