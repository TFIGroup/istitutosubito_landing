    ...
    reviews: [
      {
        ...
        avatar: 'MT',
        rating: 5,
        text: 'Avevo 32 anni e un lavoro in fabbrica che odiavo. Ho investito i miei risparmi nel corso LV2 senza sapere se avrei mai ripagato quei soldi. Dopo 2 mesi dal diploma ho aperto partita IVA. Oggi riparo 15-20 telefoni a settimana, lavoro da casa mia e guadagno il doppio di prima. Il Capotecnico mi ha seguito passo passo anche dopo il corso - quando avevo dubbi su una riparazione difficile, gli mandavo foto su WhatsApp e mi rispondeva in giornata.',
        result: 'Da operaio a 1.400 euro al mese a tecnico autonomo con 2.800 euro netti',
      },
      {
        name: 'Sara M.',
        location: 'Napoli',
        ...
        avatar: 'SM',
        rating: 5,
        text: 'Ero scettica. 1.490 euro sono tanti e online trovi corsi a 200 euro. Ma quelli sono video registrati, qui hai un tecnico vero che ti segue solo tu. La differenza si vede. Ho iniziato come secondo lavoro la sera e i weekend, riparando telefoni di amici e parenti. In 3 mesi ho recuperato l\'investimento. Ora sto valutando se lasciare il mio lavoro principale.',
        result: 'Investimento recuperato in 3 mesi lavorando part-time',
      },
      {
        name: 'Giuseppe R.',
        location: 'Caserta',
        ...
        avatar: 'GR',
        rating: 5,
        text: 'Gia lavoravo come tecnico in un negozio ma mi pagavano poco e non sapevo fare le riparazioni avanzate. Col corso LV3 ho imparato la microsaldatura - le riparazioni che il mio capo mandava fuori a 150 euro ora le faccio io. Dopo il diploma mi hanno assunto loro come tecnico senior a 1.800 euro. Il titolare mi ha detto: "Con la licenza Istituto Subito so che sai lavorare davvero".',
        result: 'Da 1.100 euro come apprendista a 1.800 euro come tecnico senior',
      },
      {
        name: 'Luca B.',
        location: 'Benevento',
        ...
        avatar: 'LB',
        rating: 5,
        text: 'Ho 24 anni e non volevo fare l\'universita. I miei genitori erano preoccupati ma ho insistito. Il corso mi ha dato un mestiere vero in 2 mesi. Oggi lavoro nel laboratorio Subito Riparato a Nocera - mi hanno assunto loro dopo il diploma. Passo le giornate a riparare telefoni invece che sui libri, e a fine mese ho i soldi in tasca.',
        result: 'Assunto nel laboratorio Subito Riparato a 3 mesi dal diploma',
      },
      {
        name: 'Chiara L.',
        location: 'Avellino',
        ...
        avatar: 'CL',
        rating: 5,
        text: 'Sono mamma di due bambini e cercavo qualcosa da fare da casa negli orari in cui dormono. Il corso LV1 era perfetto - lezioni 1-to-1 la sera quando volevo io. Ho iniziato riparando i telefoni delle mamme del gruppo WhatsApp della scuola. Passaparola incredibile. Ora ho una lista d\'attesa e guadagno 600-800 euro al mese extra senza uscire di casa.',
        result: '600-800 euro al mese extra lavorando da casa come mamma',
      },
    ],
  },
